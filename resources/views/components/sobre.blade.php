<div id="sobre" class="pt-5">
    <header class="page-header page-header-thin page-header-dark {{-- bg-gradient-primary-to-secondary --}}">
        <div class="page-header-content">
            <div class="container text-center">
                <div class="row justify-content-center">
                    <div class="col-lg-8">
                        <h1 class="page-header-title mb-3">Quem Somos</h1>
                        <p class="page-header-text">Conheça a Fibra Soluções em Internet</p>
                    </div>
                </div>
            </div>
        </div>
